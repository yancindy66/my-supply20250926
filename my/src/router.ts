...
const routes = [
  ...
  { path: '/products', component: () => import('./views/Products.vue') },
  {
    ...
    children: [
      ...
      { path: 'warehouse-receipt/stock-list', component: () => import('./views/warehouse/warehouse-receipt/StockList.vue'), meta: { title: '库存列表' } },
      ...
      // { path: 'inbound/apply', component: () => import('./views/inventory/inbound/InboundApply.vue'), meta: { title: '入库申请' } }, // 移除
