    ...
    <main class="shell-content">
      <div class="content-topbar">
        <div class="topbar-title">
          <span class="brand-text">郑商云仓</span>
          <span class="portal-badge">{{ rolePortalEn }}</span>
        </div>
        <div class="topbar-actions">
          <span class="route-chip" title="当前路由">{{ currentPath }}</span>
        </div>
      </div>
      <router-view />
    </main>
