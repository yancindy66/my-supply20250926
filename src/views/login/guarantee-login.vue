...
async function onSubmit(){
  ...
  try{
    const res = await login({ role:'guarantee', username: username.value, password: password.value });
    localStorage.setItem('authToken', res.token);
    localStorage.setItem('currentRole', 'guarantee');
    router.push('/guarantee/dashboard');
