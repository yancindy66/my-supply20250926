...
.toolbar select { height: 28px; padding: 0 12px; border-radius: 999px; border: 1px solid rgba(148,163,184,.28); background: linear-gradient(180deg, rgba(255,255,255,.66), rgba(248,250,252,.72)); }
...
.dropdown .menu { display:none; position:absolute; right:0; top:34px; min-width: 200px; background:#fff; border:1px solid #e5e7eb; border-radius:10px; box-shadow:0 10px 24px rgba(15,23,42,0.18); padding:6px; z-index: 1000; }
...
.selection-bar { display:flex; align-items:center; gap:8px; padding:8px 10px; border-radius:12px; background: linear-gradient(180deg, #ffffff, #fbfdff); box-shadow: 0 6px 18px rgba(15,23,42,0.05); margin-bottom:10px; }
.toolbar .search-input,
.toolbar select { height: 28px; padding: 0 12px; border-radius: 999px; border: 1px solid rgba(148,163,184,.28); background: linear-gradient(180deg, rgba(255,255,255,.66), rgba(248,250,252,.72)); }
...
.more-panel { position: sticky; top: 0; z-index: 12; margin: 6px 0 14px; border-radius: 12px; padding: 8px 10px; background: linear-gradient(180deg, rgba(255,255,255,.52), rgba(236,244,255,.48)); -webkit-backdrop-filter: blur(10px) saturate(1.05); backdrop-filter: blur(10px) saturate(1.05); box-shadow: 0 6px 16px rgba(15,23,42,.06); border: 1px solid rgba(148,163,184,.18); }
.more-panel .panel-row { display:flex; flex-wrap: wrap; align-items:center; gap:8px; }
.more-panel .btn { height: 24px; padding: 0 10px; border-radius: 999px; border: 1px solid rgba(148,163,184,.28); background: linear-gradient(180deg, rgba(255,255,255,.86), rgba(240,245,255,.86)); font-size: 12px; }
.more-panel .btn.btn-danger { border-color: rgba(148,163,184,.28); background: linear-gradient(180deg, rgba(255,255,255,.88), rgba(240,245,255,.88)); color:#0f172a; }
.size-row { display:flex; gap:6px; }
.size-btn { position:relative; height: 26px; padding: 0 10px; border-radius: 999px; border:1px solid rgba(255,255,255,.6); background: linear-gradient(180deg, rgba(59,130,246,.12), rgba(37,99,235,.10)); cursor:pointer; transition: transform .16s ease, box-shadow .16s ease; box-shadow: inset 0 1px 0 rgba(255,255,255,.6), 0 3px 8px rgba(15,23,42,.06); }
.size-btn:hover { transform: translateY(-1px); box-shadow: inset 0 1px 0 rgba(255,255,255,.7), 0 8px 16px rgba(15,23,42,.10); }
.size-btn.active { border-color: rgba(59,130,246,.8); }
